...
if (isset($_POST['remove'])) 
{
  ...
  echo "<script>alert('You Have Cancelled Your Booking');window.location.profile.php;</script>";
...
if (isset($_POST['transportupdate'])) {
  ...
  echo "<script>alert('Transportation booking updated successfully'); window.location='profile.php';</script>";
}
...
if (isset($_POST['packageupdate'])) {
  ...
  echo "<script>alert('Tour package booking updated successfully'); window.location='profile.php';</script>";
}
...
if(isset($_POST['delete']))
{
  ...
  echo"<script>alert('You Have Cancelled Booking');window.location='profile.php';</script>";
}
...
if (isset($_POST['hotelupdate'])) {
    ...
    echo "<script>alert('Hotel booking updated successfully'); window.location='profile.php';</script>";
}
...
<center>
<div id="tab">
<table border="1px" id="clientTable">
...
<center>
 ...
 <div id="package-table">
  ...
  <h2>Tour Package Booking Profile History</h2>
  <tr>  
   <th>slno</th>
  <th>Package Name</th>
 ...
 <?php
          ...
          if($result)
     {
      ...
      <button onclick="editform('.$row["id"].', \''.$row["destiny"].'\', \''.$row["pickuplocation"].'\',  \''.$row["pickupdate"].'\', \''.$row["packagedays"].'\', \''.$row["price"].'\', \''.$row["dropofflocation"].'\', \''.$row["status"].'\')" data-bs-toggle="modal" data-bs-target="#editpackagemodal">edit</button>
             ...
             }
      {
        ...
        if($row["status"] == 'confirm')
        {
          echo'<span style="color:green; font-weight:bold;">completed</span>';
           ...
           if($row["status"] == 'cancelled')
           {
            echo'<span style="color:red; font-weight
            :bold;">cancelled</span>';
           }
